...
The macOS Monterey Patcher is availible for a few unsupported macs hope in the future that more macs will be compatible, for now the macs that are compatible will be listed below. (This Patcher can also be used to patch Big Sur)(This Patcher Works with Beta versions of macOS Montery)
...
Monterey Patcher 0.7 will be releasing soon it is being tested on macOS Monterey beta 6 - 10
